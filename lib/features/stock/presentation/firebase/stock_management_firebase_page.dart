...
@RoutePage()
class StockManagementFirebasePage extends StatefulWidget {
  const StockManagementFirebasePage({super.key});

  @override
  State<StockManagementFirebasePage> createState() => _StockManagementFirebasePageState();
}

class _StockManagementFirebasePageState extends State<StockManagementFirebasePage> {
